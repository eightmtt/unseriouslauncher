...
public class CurseForgeApi {
    ...
    // totalHolder[0] будет заполнен общим количеством результатов
    public static List<JSONObject> searchMods(String query, String mcVersion, String rawVersion,
                                               int offset, int pageSize, int[] totalHolder) throws Exception {
        ...
        // CurseForge возвращает pagination.totalCount
        if (totalHolder != null) {

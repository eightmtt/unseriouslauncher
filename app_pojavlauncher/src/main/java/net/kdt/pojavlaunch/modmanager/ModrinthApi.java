...
public class ModrinthApi {
    ...
    // Поиск модов
    // Формат facets по документации: [["project_type:mod"],["versions:1.21.1"],["categories:fabric"]]
    public static List<JSONObject> searchMods(String query, String mcVersion, String rawVersion) throws Exception {
        // Строим facets как JSON массив массивов
    ...
    // Формат: /v2/project/{id}/version?game_versions=["1.21.1"]&loaders=["fabric"]
    ...
    private static JSONObject get(String urlStr) throws Exception {
        ...
        if (code >= 400) {
            throw new Exception("HTTP " + code + ": " + json);
        }
